    ...
    if __name__ == "__main__":
        ...
        while (start < 250):
            ...
            for movie_dict in movies_list:
                fp.write('-----------------------------------------------------' + '\n')
                fp.write('电影排名：' + movie_dict['rank'] + '\n')
                fp.write('电影名称：' + movie_dict.get('name') + '\n')
                fp.write('电影评分：' + movie_dict.get('score') + '\n')
                fp.write('电影评词：' + movie_dict.get('desc', '无评词') + '\n')
